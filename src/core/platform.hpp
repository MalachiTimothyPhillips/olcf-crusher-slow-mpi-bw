...
// allow implicit conversion between this and kernelArg (for passing to kernels)
  ...
  deviceVector_t(const size_t _offset, const size_t _nFieldPerVector, const size_t _nVectors, const size_t _wordSize, std::string _vectorName = "");
