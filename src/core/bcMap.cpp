...
static void m_setup(std::string field, std::vector<std::string> slist)
{
  for (int i = 0; i < slist.size(); i++) {
    ...
    if (key.compare("inlet") == 0)
      key = "fixedvalue";
    if (key.compare("v") == 0)
      key = "zerovalue"; // non-moving boundary, which is the same as a wall
    if (key.compare("mv") == 0)
      key = "fixedvalue";
    ...
    if (key.compare("slipy") == 0)
      key = "zeroyvalue/zerogradient";
    if (key.compare("slipz") == 0)
      key = "zerozvalue/zerogradient";
    if (key.compare("symx") == 0)
      key = "zeroxvalue/zerogradient";
    if (key.compare("symy") == 0)
      key = "zeroyvalue/zerogradient";
    if (key.compare("symz") == 0)
      key = "zerozvalue/zerogradient";
...
static void v_setup(std::string field, std::vector<std::string> slist)
{
  for (int i = 0; i < slist.size(); i++) {
    ...
    if (key.compare("inlet") == 0)
      key = "fixedvalue";
    if (key.compare("v") == 0 || key.compare("mv") == 0)
      key = "fixedvalue";
    if (key.compare("outlet") == 0)
      key = "zerogradient";
    if (key.compare("outflow") == 0)
...
{
  if (slist.size() == 0 || slist[0].compare("none") == 0)
    return;
...
int size(int isTmesh) { return isTmesh ? nbid[1] : nbid[0]; }
