...
```
>mpirun -np 1 nekrs-subcycling --p-order 7 --no-dealiasing --elements 4096 --backend CUDA
...
```
>OCCA_CXXFLAGS='-O3 -march=native -mtune=native' mpirun -np 24 --bind-to core --map-by ppr:24:socket nekrs-subcycling --p-order 7 --no-dealiasing --elements 4096 --backend CPU
