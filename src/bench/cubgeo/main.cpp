...
int main(int argc, char **argv)
{
  ...
  const std::string kernelName = "cubatureGeometricFactorsHex3D";

  const std::string fileName = installDir + "/okl/mesh/" + kernelName + ".okl";

  cubatureGeometricFactorsKernel = platform->device.buildKernel(fileName, props, true);
