...
int main(int argc, char *argv[])
{
  ...
  cout << setw(22) << tret << setw(25) << ydata[0] << setw(25) << ydata[1] << setw(25)
       << abs(ydata[0] - utrue) << setw(25) << abs(ydata[1] - vtrue) << endl;
  ...
  if (check_flag(flag, "CVodePrintAllStats"))
    return 1;
