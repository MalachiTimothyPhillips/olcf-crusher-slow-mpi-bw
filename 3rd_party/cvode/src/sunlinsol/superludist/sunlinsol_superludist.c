...
SUNLinearSolver SUNLinSol_SuperLUDIST(N_Vector y,
                                      SUNMatrix A,
                                      gridinfo_t *grid,
                                      xLUstruct_t *lu,
                                      ...
                                      SUNContext sunctx)
{
  ...
  if (y == NULL || A == NULL || grid == NULL || lu == NULL || scaleperm == NULL || solve == NULL ||
      stat == NULL || options == NULL)
    return (NULL);
...
realtype SUNLinSol_SuperLUDIST_GetBerr(SUNLinearSolver LS) { return (SLU_BERR(LS)); }

gridinfo_t *SUNLinSol_SuperLUDIST_GetGridinfo(SUNLinearSolver LS) { return (SLU_GRID(LS)); }

xLUstruct_t *SUNLinSol_SuperLUDIST_GetLUstruct(SUNLinearSolver LS) { return (SLU_LU(LS)); }
...
xSOLVEstruct_t *SUNLinSol_SuperLUDIST_GetSOLVEstruct(SUNLinearSolver LS) { return (SLU_SOLVESTRUCT(LS)); }

SuperLUStat_t *SUNLinSol_SuperLUDIST_GetSuperLUStat(SUNLinearSolver LS) { return (SLU_STAT(LS)); }
...
SUNLinearSolver_Type SUNLinSolGetType_SuperLUDIST(SUNLinearSolver S) { return (SUNLINEARSOLVER_DIRECT); }

SUNLinearSolver_ID SUNLinSolGetID_SuperLUDIST(SUNLinearSolver S) { return (SUNLINEARSOLVER_SUPERLUDIST); }
...
int SUNLinSolSolve_SuperLUDIST(SUNLinearSolver S, SUNMatrix A, N_Vector x, N_Vector b, realtype tol)
{
  int retval;
  realtype *xdata;
  SuperMatrix *Asuper;
...
int SUNLinSolSpace_SuperLUDIST(SUNLinearSolver S, long int *leniwLS, long int *lenrwLS)
{
