...
enum { SWIG_MEM_OWN = 0x01, SWIG_MEM_RVALUE = 0x02, SWIG_MEM_CONST = 0x04 };
...
SWIGEXPORT int
_wrap_FSUNLinSol_KLUReInit(SUNLinearSolver farg1, SUNMatrix farg2, int64_t const *farg3, int const *farg4)
{
  int fresult;
...
SWIGEXPORT int _wrap_FSUNLinSolSolve_KLU(SUNLinearSolver farg1,
                                         SUNMatrix farg2,
                                         N_Vector farg3,
                                         N_Vector farg4,
                                         double const *farg5)
