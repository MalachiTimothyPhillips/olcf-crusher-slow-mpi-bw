...
SWIGEXPORT SUNLinearSolver _wrap_FSUNLinSol_SPTFQMR(N_Vector farg1,
                                                    int const *farg2,
                                                    int const *farg3,
                                                    void *farg4)
{
...
SWIGEXPORT int _wrap_FSUNLinSolSetPreconditioner_SPTFQMR(SUNLinearSolver farg1,
                                                         void *farg2,
                                                         SUNPSetupFn farg3,
                                                         SUNPSolveFn farg4)
{
...
SWIGEXPORT int
_wrap_FSUNLinSolSetScalingVectors_SPTFQMR(SUNLinearSolver farg1, N_Vector farg2, N_Vector farg3)
{
  int fresult;
  SUNLinearSolver arg1 = (SUNLinearSolver)0;
...
SWIGEXPORT int _wrap_FSUNLinSolSolve_SPTFQMR(SUNLinearSolver farg1,
                                             SUNMatrix farg2,
                                             N_Vector farg3,
                                             N_Vector farg4,
                                             double const *farg5)
