...
SWIGEXPORT int
_wrap_FN_VSetSubvectorArrayPointer_ManyVector(double *farg1, N_Vector farg2, int64_t const *farg3)
{
  int fresult;
...
SWIGEXPORT void _wrap_FN_VLinearSum_ManyVector(double const *farg1,
                                               N_Vector farg2,
                                               double const *farg3,
                                               N_Vector farg4,
                                               N_Vector farg5)
...
SWIGEXPORT int
_wrap_FN_VLinearCombination_ManyVector(int const *farg1, double *farg2, void *farg3, N_Vector farg4)
{
  int fresult;
  int arg1;
...
SWIGEXPORT int
_wrap_FN_VScaleAddMulti_ManyVector(int const *farg1, double *farg2, N_Vector farg3, void *farg4, void *farg5)
{
  int fresult;
  int arg1;
  realtype *arg2 = (realtype *)0;
...
SWIGEXPORT int _wrap_FN_VLinearSumVectorArray_ManyVector(int const *farg1,
                                                         double const *farg2,
                                                         void *farg3,
                                                         double const *farg4,
                                                         void *farg5,
...
SWIGEXPORT int
_wrap_FN_VScaleVectorArray_ManyVector(int const *farg1, double *farg2, void *farg3, void *farg4)
{
  int fresult;
  int arg1;
  realtype *arg2 = (realtype *)0;
...
SWIGEXPORT int
_wrap_FN_VWrmsNormVectorArray_ManyVector(int const *farg1, void *farg2, void *farg3, double *farg4)
{
  int fresult;
  int arg1;
  N_Vector *arg2 = (N_Vector *)0;
...
SWIGEXPORT int _wrap_FN_VWrmsNormMaskVectorArray_ManyVector(int const *farg1,
                                                            void *farg2,
                                                            void *farg3,
                                                            N_Vector farg4,
                                                            double *farg5)
...
SWIGEXPORT int
_wrap_FN_VDotProdMultiLocal_ManyVector(int const *farg1, N_Vector farg2, void *farg3, double *farg4)
{
  int fresult;
  int arg1;
  N_Vector arg2 = (N_Vector)0;
