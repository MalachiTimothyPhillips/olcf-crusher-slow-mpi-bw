...
static int
VScaleSumVectorArray_Serial(int nvec, realtype c, N_Vector *X, N_Vector *Y, N_Vector *Z); /* Z=c(X+Y)  */
static int
VScaleDiffVectorArray_Serial(int nvec, realtype c, N_Vector *X, N_Vector *Y, N_Vector *Z); /* Z=c(X-Y)  */
...
N_Vector *N_VCloneVectorArray_Serial(int count, N_Vector w) { return (N_VCloneVectorArray(count, w)); }
...
realtype *N_VGetArrayPointer_Serial(N_Vector v) { return ((realtype *)NV_DATA_S(v)); }
...
int N_VLinearSumVectorArray_Serial(int nvec, realtype a, N_Vector *X, realtype b, N_Vector *Y, N_Vector *Z)
{
  int i;
  sunindextype j, N;
  realtype *xd = NULL;
...
int N_VScaleAddMultiVectorArray_Serial(int nvec,
                                       int nsum,
                                       realtype *a,
                                       N_Vector *X,
                                       N_Vector **Y,
