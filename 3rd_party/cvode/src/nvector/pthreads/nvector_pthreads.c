...
static int
VScaleSumVectorArray_Pthreads(int nvec, realtype c, N_Vector *X, N_Vector *Y, N_Vector *Z); /* Z=c(X+Y)  */
static int
VScaleDiffVectorArray_Pthreads(int nvec, realtype c, N_Vector *X, N_Vector *Y, N_Vector *Z); /* Z=c(X-Y)  */
static int
VLin1VectorArray_Pthreads(int nvec, realtype a, N_Vector *X, N_Vector *Y, N_Vector *Z); /* Z=aX+Y    */
static int
VLin2VectorArray_Pthreads(int nvec, realtype a, N_Vector *X, N_Vector *Y, N_Vector *Z); /* Z=aX-Y    */
...
static void N_VSplitLoop(int myid, int *nthreads, sunindextype *N, sunindextype *start, sunindextype *end);
 ...
 */
N_Vector_ID N_VGetVectorID_Pthreads(N_Vector v) { return SUNDIALS_NVEC_PTHREADS; }

/* ----------------------------------------------------------------------------
 * Function to create a new empty vector
 */

N_Vector N_VNewEmpty_Pthreads(sunindextype length, int num_threads, SUNContext sunctx)
{
  N_Vector v;
...
N_Vector N_VMake_Pthreads(sunindextype length, int num_threads, realtype *v_data, SUNContext sunctx)
{
  N_Vector v;
...
N_Vector *N_VCloneVectorArray_Pthreads(int count, N_Vector w) { return (N_VCloneVectorArray(count, w)); }
...
realtype *N_VGetArrayPointer_Pthreads(N_Vector v) { return ((realtype *)NV_DATA_PT(v)); }
...
static void *N_VMaxNorm_PT(void *thread_data)
{
  ...
  local_max = ZERO;
  for (i = start; i < end; i++)
    if (SUNRabs(xd[i]) > local_max)
      local_max = SUNRabs(xd[i]);
...
int N_VLinearSumVectorArray_Pthreads(int nvec, realtype a, N_Vector *X, realtype b, N_Vector *Y, N_Vector *Z)
{
  sunindextype N;
  int i, nthreads;
  pthread_t *threads;
  ...
  for (i = 0; i < nthreads; i++) {
    ...
    /* create threads and call pthread companion function */
    pthread_create(&threads[i], &attr, N_VLinearSumVectorArray_PT, (void *)&thread_data[i]);
  }
...
int N_VScaleVectorArray_Pthreads(int nvec, realtype *c, N_Vector *X, N_Vector *Z)
{
  ...
  for (i = 0; i < nthreads; i++) {
    ...
    /* create threads and call pthread companion function */
    pthread_create(&threads[i], &attr, N_VScaleVectorArray_PT, (void *)&thread_data[i]);
  }
...
int N_VConstVectorArray_Pthreads(int nvec, realtype c, N_Vector *Z)
{
  ...
  for (i = 0; i < nthreads; i++) {
    ...
    /* create threads and call pthread companion function */
    pthread_create(&threads[i], &attr, N_VConstVectorArray_PT, (void *)&thread_data[i]);
  }
...
int N_VWrmsNormVectorArray_Pthreads(int nvec, N_Vector *X, N_Vector *W, realtype *nrm)
{
  ...
  for (i = 0; i < nthreads; i++) {
    ...
    /* create threads and call pthread companion function */
    pthread_create(&threads[i], &attr, N_VWrmsNormVectorArray_PT, (void *)&thread_data[i]);
  }
...
int N_VWrmsNormMaskVectorArray_Pthreads(int nvec, N_Vector *X, N_Vector *W, N_Vector id, realtype *nrm)
{
  sunindextype N;
  int i, nthreads;
  pthread_t *threads;
  ...
  for (i = 0; i < nthreads; i++) {
    ...
    /* create threads and call pthread companion function */
    pthread_create(&threads[i], &attr, N_VWrmsNormMaskVectorArray_PT, (void *)&thread_data[i]);
  }
...
int N_VScaleAddMultiVectorArray_Pthreads(int nvec,
                                         int nsum,
                                         realtype *a,
                                         N_Vector *X,
                                         N_Vector **Y,
                                         N_Vector **Z)
{
  ...
  for (i = 0; i < nthreads; i++) {
    ...
    /* create threads and call pthread companion function */
    pthread_create(&threads[i], &attr, N_VScaleAddMultiVectorArray_PT, (void *)&thread_data[i]);
  }
...
int N_VLinearCombinationVectorArray_Pthreads(int nvec, int nsum, realtype *c, N_Vector **X, N_Vector *Z)
{
  sunindextype N;
  int i, j, nthreads;
  pthread_t *threads;
  ...
  for (i = 0; i < nthreads; i++) {
    ...
    /* create threads and call pthread companion function */
    pthread_create(&threads[i], &attr, N_VLinearCombinationVectorArray_PT, (void *)&thread_data[i]);
  }
