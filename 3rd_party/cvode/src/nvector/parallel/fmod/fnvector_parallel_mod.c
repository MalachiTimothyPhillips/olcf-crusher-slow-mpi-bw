...
SWIGEXPORT N_Vector _wrap_FN_VNew_Parallel(int const *farg1,
                                           int64_t const *farg2,
                                           int64_t const *farg3,
                                           void *farg4)
{
...
SWIGEXPORT N_Vector _wrap_FN_VNewEmpty_Parallel(int const *farg1,
                                                int64_t const *farg2,
                                                int64_t const *farg3,
                                                void *farg4)
{
...
SWIGEXPORT N_Vector _wrap_FN_VMake_Parallel(int const *farg1,
                                            int64_t const *farg2,
                                            int64_t const *farg3,
                                            double *farg4,
                                            void *farg5)
...
SWIGEXPORT void _wrap_FN_VLinearSum_Parallel(double const *farg1,
                                             N_Vector farg2,
                                             double const *farg3,
                                             N_Vector farg4,
                                             N_Vector farg5)
...
SWIGEXPORT int
_wrap_FN_VLinearCombination_Parallel(int const *farg1, double *farg2, void *farg3, N_Vector farg4)
{
  int fresult;
  int arg1;
...
SWIGEXPORT int
_wrap_FN_VScaleAddMulti_Parallel(int const *farg1, double *farg2, N_Vector farg3, void *farg4, void *farg5)
{
  int fresult;
  int arg1;
  realtype *arg2 = (realtype *)0;
...
SWIGEXPORT int _wrap_FN_VLinearSumVectorArray_Parallel(int const *farg1,
                                                       double const *farg2,
                                                       void *farg3,
                                                       double const *farg4,
                                                       void *farg5,
...
SWIGEXPORT int
_wrap_FN_VWrmsNormVectorArray_Parallel(int const *farg1, void *farg2, void *farg3, double *farg4)
{
  int fresult;
  int arg1;
  N_Vector *arg2 = (N_Vector *)0;
...
SWIGEXPORT int _wrap_FN_VWrmsNormMaskVectorArray_Parallel(int const *farg1,
                                                          void *farg2,
                                                          void *farg3,
                                                          N_Vector farg4,
                                                          double *farg5)
...
SWIGEXPORT int
_wrap_FN_VDotProdMultiLocal_Parallel(int const *farg1, N_Vector farg2, void *farg3, double *farg4)
{
  int fresult;
  int arg1;
  N_Vector arg2 = (N_Vector)0;
