...
N_Vector_ID N_VGetVectorID_MPIPlusX(N_Vector v) { return SUNDIALS_NVEC_MPIPLUSX; }

realtype *N_VGetArrayPointer_MPIPlusX(N_Vector v) { return N_VGetSubvectorArrayPointer_MPIManyVector(v, 0); }
...
N_Vector N_VGetLocalVector_MPIPlusX(N_Vector v) { return MPIPLUSX_LOCAL_VECTOR(v); }

sunindextype N_VGetLocalLength_MPIPlusX(N_Vector v) { return N_VGetLength(MPIPLUSX_LOCAL_VECTOR(v)); }
