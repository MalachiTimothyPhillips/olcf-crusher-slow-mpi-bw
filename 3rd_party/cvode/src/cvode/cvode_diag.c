...
extern int cvDiagSetup_formY(const realtype h,
                             const realtype r,
...
extern int cvDiagSetup_buildM(const realtype fract,
...
static int CVDiagSetup(CVodeMem cv_mem,
                       int convfail,
                       N_Vector ypred,
                       N_Vector fpred,
                       booleantype *jcurPtr,
...
static int CVDiagSolve(CVodeMem cv_mem, N_Vector b, N_Vector weight, N_Vector ycur, N_Vector fcur);
