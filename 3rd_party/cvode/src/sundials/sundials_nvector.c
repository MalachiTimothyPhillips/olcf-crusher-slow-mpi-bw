...
realtype *N_VGetArrayPointer(N_Vector v) { return ((realtype *)v->ops->nvgetarraypointer(v)); }
...
sunindextype N_VGetLength(N_Vector v) { return ((sunindextype)v->ops->nvgetlength(v)); }
