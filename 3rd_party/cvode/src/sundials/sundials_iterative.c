...
int QRfact(int n, realtype **h, realtype *q, int job) { return (SUNQRfact(n, h, q, job)); }
...
int QRsol(int n, realtype **h, realtype *q, realtype *b) { return (SUNQRsol(n, h, q, b)); }
...
int SUNQRAdd_MGS(N_Vector *Q, realtype *R, N_Vector df, int m, int mMax, void *QRdata)
{
  sunindextype j;
...
int SUNQRAdd_DCGS2(N_Vector *Q, realtype *R, N_Vector df, int m, int mMax, void *QRdata)
{
  sunindextype j;
  SUNQRData qrdata = (SUNQRData)QRdata;
