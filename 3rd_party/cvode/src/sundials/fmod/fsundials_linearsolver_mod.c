...
SWIGEXPORT int
_wrap_FSUNModifiedGS(void *farg1, void *farg2, int const *farg3, int const *farg4, double *farg5)
{
  int fresult;
...
SWIGEXPORT int _wrap_FSUNClassicalGS(void *farg1,
                                     void *farg2,
                                     int const *farg3,
                                     int const *farg4,
                                     double *farg5,
...
SWIGEXPORT int _wrap_FClassicalGS(void *farg1,
                                  void *farg2,
                                  int const *farg3,
                                  int const *farg4,
                                  double *farg5,
...
SWIGEXPORT int _wrap_FSUNQRAdd_MGS(void *farg1,
                                   double *farg2,
                                   N_Vector farg3,
                                   int const *farg4,
                                   int const *farg5,
...
SWIGEXPORT int _wrap_FSUNQRAdd_ICWY(void *farg1,
                                    double *farg2,
                                    N_Vector farg3,
                                    int const *farg4,
                                    int const *farg5,
...
SWIGEXPORT int _wrap_FSUNQRAdd_ICWY_SB(void *farg1,
                                       double *farg2,
                                       N_Vector farg3,
                                       int const *farg4,
                                       int const *farg5,
...
SWIGEXPORT int _wrap_FSUNQRAdd_CGS2(void *farg1,
                                    double *farg2,
                                    N_Vector farg3,
                                    int const *farg4,
                                    int const *farg5,
...
SWIGEXPORT int _wrap_FSUNQRAdd_DCGS2(void *farg1,
                                     double *farg2,
                                     N_Vector farg3,
                                     int const *farg4,
                                     int const *farg5,
...
SWIGEXPORT int _wrap_FSUNQRAdd_DCGS2_SB(void *farg1,
                                        double *farg2,
                                        N_Vector farg3,
                                        int const *farg4,
                                        int const *farg5,
...
SWIGEXPORT int
_wrap_FSUNLinSolSetPreconditioner(SUNLinearSolver farg1, void *farg2, SUNPSetupFn farg3, SUNPSolveFn farg4)
{
  int fresult;
  SUNLinearSolver arg1 = (SUNLinearSolver)0;
  void *arg2 = (void *)0;
...
SWIGEXPORT int _wrap_FSUNLinSolSolve(SUNLinearSolver farg1,
                                     SUNMatrix farg2,
                                     N_Vector farg3,
                                     N_Vector farg4,
                                     double const *farg5)
