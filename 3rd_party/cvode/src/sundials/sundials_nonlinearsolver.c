...
static SUNProfiler getSUNProfiler(SUNNonlinearSolver NLS) { return (NLS->sunctx->profiler); }
#endif
...
SUNNonlinearSolver_Type SUNNonlinSolGetType(SUNNonlinearSolver NLS) { return (NLS->ops->gettype(NLS)); }
