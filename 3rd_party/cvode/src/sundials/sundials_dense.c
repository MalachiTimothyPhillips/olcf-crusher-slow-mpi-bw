...
void DenseGETRS(SUNDlsMat A, sunindextype *p, realtype *b) { SUNDlsMat_denseGETRS(A->cols, A->N, p, b); }

sunindextype SUNDlsMat_DensePOTRF(SUNDlsMat A) { return (SUNDlsMat_densePOTRF(A->cols, A->M)); }

sunindextype DensePOTRF(SUNDlsMat A) { return (SUNDlsMat_densePOTRF(A->cols, A->M)); }

void SUNDlsMat_DensePOTRS(SUNDlsMat A, realtype *b) { SUNDlsMat_densePOTRS(A->cols, A->M, b); }

void DensePOTRS(SUNDlsMat A, realtype *b) { SUNDlsMat_densePOTRS(A->cols, A->M, b); }
...
void SUNDlsMat_DenseCopy(SUNDlsMat A, SUNDlsMat B) { SUNDlsMat_denseCopy(A->cols, B->cols, A->M, A->N); }

void DenseCopy(SUNDlsMat A, SUNDlsMat B) { SUNDlsMat_denseCopy(A->cols, B->cols, A->M, A->N); }

void SUNDlsMat_DenseScale(realtype c, SUNDlsMat A) { SUNDlsMat_denseScale(c, A->cols, A->M, A->N); }

void DenseScale(realtype c, SUNDlsMat A) { SUNDlsMat_denseScale(c, A->cols, A->M, A->N); }
...
void DenseMatvec(SUNDlsMat A, realtype *x, realtype *y) { SUNDlsMat_denseMatvec(A->cols, x, y, A->M, A->N); }
...
sunindextype densePOTRF(realtype **a, sunindextype m) { return (SUNDlsMat_densePOTRF(a, m)); }
...
void densePOTRS(realtype **a, sunindextype m, realtype *b) { SUNDlsMat_densePOTRS(a, m, b); }
...
int SUNDlsMat_denseORMQR(realtype **a,
                         sunindextype m,
                         sunindextype n,
                         realtype *beta,
                         realtype *vn,
...
void denseAddIdentity(realtype **a, sunindextype n) { SUNDlsMat_denseAddIdentity(a, n); }
