...
SUNDlsMat NewDenseMat(sunindextype M, sunindextype N) { return (SUNDlsMat_NewDenseMat(M, N)); }
...
realtype **newDenseMat(sunindextype m, sunindextype n) { return (SUNDlsMat_newDenseMat(m, n)); }
...
sunindextype *NewIndexArray(sunindextype N) { return (SUNDlsMat_NewIndexArray(N)); }
