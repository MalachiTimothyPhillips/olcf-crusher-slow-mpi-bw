...
static int ConvTest(SUNNonlinearSolver NLS, N_Vector y, N_Vector del, realtype tol, N_Vector ewt, void *mem);
...
int main(int argc, char *argv[])
{
  ...
  retval = SUNNonlinSolSolve(NLS, Imem->y0, Imem->ycor, Imem->w, tol, SUNTRUE, Imem);
...
int ConvTest(SUNNonlinearSolver NLS, N_Vector y, N_Vector del, realtype tol, N_Vector ewt, void *mem)
{
  realtype delnrm;
