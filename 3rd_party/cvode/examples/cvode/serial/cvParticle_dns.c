...
static int Jac(realtype t,
               ...
               N_Vector tmp2,
               N_Vector tmp3);
static int Proj(realtype t, N_Vector ycur, N_Vector corr, realtype epsProj, N_Vector err, void *user_data);
...
static int ComputeError(realtype t, N_Vector y, N_Vector e, realtype *ec, UserData udata);
static int
WriteOutput(realtype t, N_Vector y, N_Vector e, realtype ec, int screenfile, FILE *YFID, FILE *EFID);
