...
__global__ void fKernel(const realtype *u,
                        realtype *udot,
                        sunindextype MX,
                        sunindextype MY,
                        realtype hordc,
...
__global__ void jtvKernel(const realtype *vdata,
                          realtype *Jvdata,
                          sunindextype MX,
                          sunindextype MY,
                          realtype hordc,
...
int main(int argc, char **argv)
{
  ...
  if (check_retval((void *)u, "N_VNew_Hip", 0))
    return (1);
  ...
  if (check_retval(&retval, "N_VSetKernelExecPolicy_Hip", 0))
    return (1);
...
UserData SetUserData(int argc, char *argv[])
{
  ...
  if (check_retval((void *)ud, "AllocUserData", 2))
    return (NULL);
