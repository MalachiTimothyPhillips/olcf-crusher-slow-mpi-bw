...
extern void
dcopy_f77(sunindextype *n, const double *x, const sunindextype *inc_x, double *y, const sunindextype *inc_y);

extern void dscal_f77(sunindextype *n, const double *alpha, double *x, const sunindextype *inc_x);

extern void
scopy_f77(sunindextype *n, const float *x, const sunindextype *inc_x, float *y, const sunindextype *inc_y);

extern void sscal_f77(sunindextype *n, const float *alpha, float *x, const sunindextype *inc_x);

/* Level-2 BLAS */

extern void dgemv_f77(const char *trans,
                      sunindextype *m,
                      sunindextype *n,
                      const double *alpha,
                      const double *a,
...
extern void dtrsv_f77(const char *uplo,
                      const char *trans,
                      const char *diag,
                      const sunindextype *n,
                      const double *a,
                      const sunindextype *lda,
                      double *x,
                      const sunindextype *inc_x);

extern void sgemv_f77(const char *trans,
                      sunindextype *m,
                      sunindextype *n,
                      const float *alpha,
                      const float *a,
...
extern void strsv_f77(const char *uplo,
                      const char *trans,
                      const char *diag,
                      const sunindextype *n,
                      const float *a,
...
extern void dsyrk_f77(const char *uplo,
                      const char *trans,
                      const sunindextype *n,
                      ...
                      const double *beta,
                      const double *c,
                      const sunindextype *ldc);

extern void ssyrk_f77(const char *uplo,
                      const char *trans,
                      const sunindextype *n,
                      const sunindextype *k,
                      const float *alpha,
...
extern void dgbtrf_f77(const sunindextype *m,
                       const sunindextype *n,
                       const sunindextype *kl,
                       const sunindextype *ku,
                       double *ab,
                       sunindextype *ldab,
                       sunindextype *ipiv,
                       sunindextype *info);

extern void dgbtrs_f77(const char *trans,
                       const sunindextype *n,
                       const sunindextype *kl,
                       const sunindextype *ku,
                       const sunindextype *nrhs,
                       double *ab,
                       const sunindextype *ldab,
                       sunindextype *ipiv,
                       double *b,
                       const sunindextype *ldb,
                       sunindextype *info);

extern void dgeqp3_f77(const sunindextype *m,
                       const sunindextype *n,
                       double *a,
                       const sunindextype *lda,
                       sunindextype *jpvt,
                       double *tau,
                       double *work,
                       const sunindextype *lwork,
                       sunindextype *info);

extern void dgeqrf_f77(const sunindextype *m,
                       const sunindextype *n,
                       double *a,
                       const sunindextype *lda,
                       double *tau,
...
extern void dgetrf_f77(const sunindextype *m,
                       const sunindextype *n,
                       double *a,
                       sunindextype *lda,
                       sunindextype *ipiv,
...
extern void dgetrs_f77(const char *trans,
                       const sunindextype *n,
                       const sunindextype *nrhs,
                       double *a,
                       const sunindextype *lda,
...
extern void dormqr_f77(const char *side,
                       const char *trans,
                       const sunindextype *m,
                       const sunindextype *n,
                       const sunindextype *k,
                       double *a,
                       const sunindextype *lda,
...
extern void
dpotrf_f77(const char *uplo, const sunindextype *n, double *a, sunindextype *lda, sunindextype *info);

extern void dpotrs_f77(const char *uplo,
                       const sunindextype *n,
                       const sunindextype *nrhs,
                       double *a,
                       const sunindextype *lda,
...
extern void sgbtrf_f77(const sunindextype *m,
                       const sunindextype *n,
                       const sunindextype *kl,
                       const sunindextype *ku,
                       float *ab,
...
extern void sgbtrs_f77(const char *trans,
                       const sunindextype *n,
                       const sunindextype *kl,
                       const sunindextype *ku,
                       const sunindextype *nrhs,
...
extern void sgeqp3_f77(const sunindextype *m,
                       const sunindextype *n,
                       float *a,
                       const sunindextype *lda,
                       sunindextype *jpvt,
...
extern void sgeqrf_f77(const sunindextype *m,
                       const sunindextype *n,
                       float *a,
                       const sunindextype *lda,
                       float *tau,
...
extern void sgetrf_f77(const sunindextype *m,
                       const sunindextype *n,
                       float *a,
                       sunindextype *lda,
                       sunindextype *ipiv,
...
extern void sgetrs_f77(const char *trans,
                       const sunindextype *n,
                       const sunindextype *nrhs,
                       float *a,
                       const sunindextype *lda,
...
extern void sormqr_f77(const char *side,
                       const char *trans,
                       const sunindextype *m,
                       const sunindextype *n,
                       const sunindextype *k,
...
extern void
spotrf_f77(const char *uplo, const sunindextype *n, float *a, sunindextype *lda, sunindextype *info);

extern void spotrs_f77(const char *uplo,
                       const sunindextype *n,
                       const sunindextype *nrhs,
                       float *a,
                       const sunindextype *lda,
