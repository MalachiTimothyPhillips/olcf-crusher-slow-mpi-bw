...
SUNDIALS_EXPORT
int SUNDlsMat_denseGEQRF(realtype **a, sunindextype m, sunindextype n, realtype *beta, realtype *wrk);
SUNDIALS_DEPRECATED_EXPORT_MSG("use SUNDlsMat_denseGEQRF instead")
int denseGEQRF(realtype **a, sunindextype m, sunindextype n, realtype *beta, realtype *wrk);
