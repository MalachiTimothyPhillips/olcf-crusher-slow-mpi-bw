...
struct _SUNMemoryHelper_Ops {
  ...
  int (*alloc)(SUNMemoryHelper, SUNMemory *memptr, size_t mem_size, SUNMemoryType mem_type, void *queue);
  int (*dealloc)(SUNMemoryHelper, SUNMemory mem, void *queue);
  int (*copy)(SUNMemoryHelper, SUNMemory dst, SUNMemory src, size_t mem_size, void *queue);

  /* operations that provide default implementations */
  int (*copyasync)(SUNMemoryHelper, SUNMemory dst, SUNMemory src, size_t mem_size, void *queue);
...
SUNDIALS_EXPORT
int SUNMemoryHelper_Alloc(SUNMemoryHelper,
                          SUNMemory *memptr,
                          size_t mem_size,
...
SUNDIALS_EXPORT
int SUNMemoryHelper_Copy(SUNMemoryHelper, SUNMemory dst, SUNMemory src, size_t mem_size, void *queue);
...
SUNDIALS_EXPORT
int SUNMemoryHelper_CopyAsync(SUNMemoryHelper, SUNMemory dst, SUNMemory src, size_t mem_size, void *queue);
...
SUNDIALS_EXPORT int SUNMemoryHelper_CopyOps(SUNMemoryHelper src, SUNMemoryHelper dst);
