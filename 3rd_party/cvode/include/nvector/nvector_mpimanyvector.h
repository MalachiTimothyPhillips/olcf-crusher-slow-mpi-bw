...
SUNDIALS_EXPORT N_Vector N_VGetSubvector_MPIManyVector(N_Vector v, sunindextype vec_num);

SUNDIALS_EXPORT realtype *N_VGetSubvectorArrayPointer_MPIManyVector(N_Vector v, sunindextype vec_num);

SUNDIALS_EXPORT int
N_VSetSubvectorArrayPointer_MPIManyVector(realtype *v_data, N_Vector v, sunindextype vec_num);
...
SUNDIALS_EXPORT void N_VSpace_MPIManyVector(N_Vector v, sunindextype *lrw, sunindextype *liw);
...
SUNDIALS_EXPORT void N_VLinearSum_MPIManyVector(realtype a, N_Vector x, realtype b, N_Vector y, N_Vector z);
...
SUNDIALS_EXPORT void N_VAddConst_MPIManyVector(N_Vector x, realtype b, N_Vector z);
...
SUNDIALS_EXPORT realtype N_VWrmsNormMask_MPIManyVector(N_Vector x, N_Vector w, N_Vector id);
...
SUNDIALS_EXPORT booleantype N_VConstrMask_MPIManyVector(N_Vector c, N_Vector x, N_Vector m);
SUNDIALS_EXPORT realtype N_VMinQuotient_MPIManyVector(N_Vector num, N_Vector denom);

/* fused vector operations */
SUNDIALS_EXPORT int N_VLinearCombination_MPIManyVector(int nvec, realtype *c, N_Vector *V, N_Vector z);
SUNDIALS_EXPORT int
N_VScaleAddMulti_MPIManyVector(int nvec, realtype *a, N_Vector x, N_Vector *Y, N_Vector *Z);
SUNDIALS_EXPORT int N_VDotProdMulti_MPIManyVector(int nvec, N_Vector x, N_Vector *Y, realtype *dotprods);

/* single buffer reduction operations */
SUNDIALS_EXPORT int N_VDotProdMultiLocal_MPIManyVector(int nvec, N_Vector x, N_Vector *Y, realtype *dotprods);
SUNDIALS_EXPORT int N_VDotProdMultiAllReduce_MPIManyVector(int nvec_total, N_Vector x, realtype *sum);
...
SUNDIALS_EXPORT int N_VLinearSumVectorArray_MPIManyVector(int nvec,
                                                          ...
                                                          N_Vector *Y,
                                                          N_Vector *Z);
SUNDIALS_EXPORT int N_VScaleVectorArray_MPIManyVector(int nvec, realtype *c, N_Vector *X, N_Vector *Z);
SUNDIALS_EXPORT int N_VConstVectorArray_MPIManyVector(int nvecs, realtype c, N_Vector *Z);
SUNDIALS_EXPORT int N_VWrmsNormVectorArray_MPIManyVector(int nvecs, N_Vector *X, N_Vector *W, realtype *nrm);
SUNDIALS_EXPORT int
N_VWrmsNormMaskVectorArray_MPIManyVector(int nvec, N_Vector *X, N_Vector *W, N_Vector id, realtype *nrm);
...
SUNDIALS_EXPORT realtype N_VWSqrSumMaskLocal_MPIManyVector(N_Vector x, N_Vector w, N_Vector id);
SUNDIALS_EXPORT booleantype N_VInvTestLocal_MPIManyVector(N_Vector x, N_Vector z);
SUNDIALS_EXPORT booleantype N_VConstrMaskLocal_MPIManyVector(N_Vector c, N_Vector x, N_Vector m);
SUNDIALS_EXPORT realtype N_VMinQuotientLocal_MPIManyVector(N_Vector num, N_Vector denom);
