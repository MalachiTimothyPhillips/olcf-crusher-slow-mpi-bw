...
SUNDIALS_EXPORT N_Vector N_VNew_Pthreads(sunindextype vec_length, int n_threads, SUNContext sunctx);

SUNDIALS_EXPORT N_Vector N_VNewEmpty_Pthreads(sunindextype vec_length, int n_threads, SUNContext sunctx);
...
SUNDIALS_EXPORT int N_VLinearCombination_Pthreads(int nvec, realtype *c, N_Vector *X, N_Vector z);
SUNDIALS_EXPORT int N_VScaleAddMulti_Pthreads(int nvec, realtype *a, N_Vector x, N_Vector *Y, N_Vector *Z);
SUNDIALS_EXPORT int N_VDotProdMulti_Pthreads(int nvec, N_Vector x, N_Vector *Y, realtype *dotprods);

/* vector array operations */
SUNDIALS_EXPORT int
N_VLinearSumVectorArray_Pthreads(int nvec, realtype a, N_Vector *X, realtype b, N_Vector *Y, N_Vector *Z);
SUNDIALS_EXPORT int N_VScaleVectorArray_Pthreads(int nvec, realtype *c, N_Vector *X, N_Vector *Z);
SUNDIALS_EXPORT int N_VConstVectorArray_Pthreads(int nvec, realtype c, N_Vector *Z);
SUNDIALS_EXPORT int N_VWrmsNormVectorArray_Pthreads(int nvec, N_Vector *X, N_Vector *W, realtype *nrm);
SUNDIALS_EXPORT int
N_VWrmsNormMaskVectorArray_Pthreads(int nvec, N_Vector *X, N_Vector *W, N_Vector id, realtype *nrm);
SUNDIALS_EXPORT int N_VScaleAddMultiVectorArray_Pthreads(int nvec,
                                                         int nsum,
                                                         realtype *a,
                                                         N_Vector *X,
                                                         N_Vector **Y,
                                                         N_Vector **Z);
SUNDIALS_EXPORT int
N_VLinearCombinationVectorArray_Pthreads(int nvec, int nsum, realtype *c, N_Vector **X, N_Vector *Z);
...
SUNDIALS_DEPRECATED_EXPORT N_Vector *N_VCloneVectorArray_Pthreads(int count, N_Vector w);

/* use N_VCloneVectorArrayEmpty */
SUNDIALS_DEPRECATED_EXPORT N_Vector *N_VCloneVectorArrayEmpty_Pthreads(int count, N_Vector w);

/* use N_VDestroyVectorArray */
SUNDIALS_DEPRECATED_EXPORT void N_VDestroyVectorArray_Pthreads(N_Vector *vs, int count);
