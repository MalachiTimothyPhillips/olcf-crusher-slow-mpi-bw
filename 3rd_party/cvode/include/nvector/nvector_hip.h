...
SUNDIALS_EXPORT N_Vector N_VMake_Hip(sunindextype length,
                                     ...
                                     realtype *d_vdata,
                                     SUNContext sunctx);
SUNDIALS_EXPORT N_Vector N_VMakeManaged_Hip(sunindextype length, realtype *vdata, SUNContext sunctx);
...
SUNDIALS_EXPORT int N_VLinearCombination_Hip(int nvec, realtype *c, N_Vector *X, N_Vector Z);
SUNDIALS_EXPORT int N_VScaleAddMulti_Hip(int nvec, realtype *c, N_Vector X, N_Vector *Y, N_Vector *Z);
SUNDIALS_EXPORT int N_VDotProdMulti_Hip(int nvec, N_Vector x, N_Vector *Y, realtype *dotprods);

/* vector array operations */
SUNDIALS_EXPORT int
N_VLinearSumVectorArray_Hip(int nvec, realtype a, N_Vector *X, realtype b, N_Vector *Y, N_Vector *Z);
SUNDIALS_EXPORT int N_VScaleVectorArray_Hip(int nvec, realtype *c, N_Vector *X, N_Vector *Z);
SUNDIALS_EXPORT int N_VConstVectorArray_Hip(int nvec, realtype c, N_Vector *Z);
SUNDIALS_EXPORT int
N_VScaleAddMultiVectorArray_Hip(int nvec, int nsum, realtype *a, N_Vector *X, N_Vector **Y, N_Vector **Z);
SUNDIALS_EXPORT int
N_VLinearCombinationVectorArray_Hip(int nvec, int nsum, realtype *c, N_Vector **X, N_Vector *Z);
SUNDIALS_EXPORT int N_VWrmsNormVectorArray_Hip(int nvec, N_Vector *X, N_Vector *W, realtype *nrm);
SUNDIALS_EXPORT int
N_VWrmsNormMaskVectorArray_Hip(int nvec, N_Vector *X, N_Vector *W, N_Vector id, realtype *nrm);
