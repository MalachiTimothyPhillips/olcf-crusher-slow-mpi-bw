...
SUNDIALS_EXPORT N_Vector N_VGetSubvector_ManyVector(N_Vector v, sunindextype vec_num);

SUNDIALS_EXPORT realtype *N_VGetSubvectorArrayPointer_ManyVector(N_Vector v, sunindextype vec_num);

SUNDIALS_EXPORT int
N_VSetSubvectorArrayPointer_ManyVector(realtype *v_data, N_Vector v, sunindextype vec_num);
...
SUNDIALS_EXPORT void N_VSpace_ManyVector(N_Vector v, sunindextype *lrw, sunindextype *liw);
SUNDIALS_EXPORT sunindextype N_VGetLength_ManyVector(N_Vector v);
SUNDIALS_EXPORT void N_VLinearSum_ManyVector(realtype a, N_Vector x, realtype b, N_Vector y, N_Vector z);
...
SUNDIALS_EXPORT realtype N_VWrmsNormMask_ManyVector(N_Vector x, N_Vector w, N_Vector id);
...
SUNDIALS_EXPORT int N_VLinearCombination_ManyVector(int nvec, realtype *c, N_Vector *V, N_Vector z);
SUNDIALS_EXPORT int N_VScaleAddMulti_ManyVector(int nvec, realtype *a, N_Vector x, N_Vector *Y, N_Vector *Z);
SUNDIALS_EXPORT int N_VDotProdMulti_ManyVector(int nvec, N_Vector x, N_Vector *Y, realtype *dotprods);

/* vector array operations */
SUNDIALS_EXPORT int
N_VLinearSumVectorArray_ManyVector(int nvec, realtype a, N_Vector *X, realtype b, N_Vector *Y, N_Vector *Z);
SUNDIALS_EXPORT int N_VScaleVectorArray_ManyVector(int nvec, realtype *c, N_Vector *X, N_Vector *Z);
SUNDIALS_EXPORT int N_VConstVectorArray_ManyVector(int nvecs, realtype c, N_Vector *Z);
SUNDIALS_EXPORT int N_VWrmsNormVectorArray_ManyVector(int nvecs, N_Vector *X, N_Vector *W, realtype *nrm);
SUNDIALS_EXPORT int
N_VWrmsNormMaskVectorArray_ManyVector(int nvec, N_Vector *X, N_Vector *W, N_Vector id, realtype *nrm);
...
SUNDIALS_EXPORT realtype N_VWSqrSumMaskLocal_ManyVector(N_Vector x, N_Vector w, N_Vector id);
SUNDIALS_EXPORT booleantype N_VInvTestLocal_ManyVector(N_Vector x, N_Vector z);
SUNDIALS_EXPORT booleantype N_VConstrMaskLocal_ManyVector(N_Vector c, N_Vector x, N_Vector m);
SUNDIALS_EXPORT realtype N_VMinQuotientLocal_ManyVector(N_Vector num, N_Vector denom);

/* OPTIONAL single buffer reduction operations */
SUNDIALS_EXPORT int N_VDotProdMultiLocal_ManyVector(int nvec, N_Vector x, N_Vector *Y, realtype *dotprods);
