...
SUNDIALS_EXPORT N_Vector N_VNew_Sycl(sunindextype length, ::sycl::queue *Q, SUNContext sunctx);
SUNDIALS_EXPORT N_Vector N_VNewManaged_Sycl(sunindextype length, ::sycl::queue *Q, SUNContext sunctx);
...
SUNDIALS_EXPORT void N_VSpace_Sycl(N_Vector v, sunindextype *lrw, sunindextype *liw);

/* standard vector operations */
SUNDIALS_EXPORT void N_VLinearSum_Sycl(realtype a, N_Vector x, realtype b, N_Vector y, N_Vector z);
...
SUNDIALS_EXPORT realtype N_VWrmsNormMask_Sycl(N_Vector x, N_Vector w, N_Vector id);
...
SUNDIALS_EXPORT booleantype N_VConstrMask_Sycl(N_Vector c, N_Vector x, N_Vector m);
SUNDIALS_EXPORT realtype N_VMinQuotient_Sycl(N_Vector num, N_Vector denom);

/* fused vector operations */
SUNDIALS_EXPORT int N_VLinearCombination_Sycl(int nvec, realtype *c, N_Vector *X, N_Vector Z);
SUNDIALS_EXPORT int N_VScaleAddMulti_Sycl(int nvec, realtype *c, N_Vector X, N_Vector *Y, N_Vector *Z);

/* vector array operations */
SUNDIALS_EXPORT int
N_VLinearSumVectorArray_Sycl(int nvec, realtype a, N_Vector *X, realtype b, N_Vector *Y, N_Vector *Z);
SUNDIALS_EXPORT int N_VScaleVectorArray_Sycl(int nvec, realtype *c, N_Vector *X, N_Vector *Z);
SUNDIALS_EXPORT int N_VConstVectorArray_Sycl(int nvec, realtype c, N_Vector *Z);
SUNDIALS_EXPORT int
N_VScaleAddMultiVectorArray_Sycl(int nvec, int nsum, realtype *a, N_Vector *X, N_Vector **Y, N_Vector **Z);
SUNDIALS_EXPORT int
N_VLinearCombinationVectorArray_Sycl(int nvec, int nsum, realtype *c, N_Vector **X, N_Vector *Z);
SUNDIALS_EXPORT int N_VWrmsNormVectorArray_Sycl(int nvec, N_Vector *X, N_Vector *W, realtype *nrm);
SUNDIALS_EXPORT int
N_VWrmsNormMaskVectorArray_Sycl(int nvec, N_Vector *X, N_Vector *W, N_Vector id, realtype *nrm);

/* OPTIONAL local reduction kernels (no parallel communication) */
SUNDIALS_EXPORT realtype N_VWSqrSumLocal_Sycl(N_Vector x, N_Vector w);
SUNDIALS_EXPORT realtype N_VWSqrSumMaskLocal_Sycl(N_Vector x, N_Vector w, N_Vector id);
...
SUNDIALS_EXPORT int N_VEnableLinearSumVectorArray_Sycl(N_Vector v, booleantype tf);
...
SUNDIALS_EXPORT int N_VEnableWrmsNormMaskVectorArray_Sycl(N_Vector v, booleantype tf);
SUNDIALS_EXPORT int N_VEnableScaleAddMultiVectorArray_Sycl(N_Vector v, booleantype tf);
SUNDIALS_EXPORT int N_VEnableLinearCombinationVectorArray_Sycl(N_Vector v, booleantype tf);
