...
SUNDIALS_EXPORT
int SUNMemoryHelper_Alloc_Sycl(SUNMemoryHelper helper,
                               SUNMemory *memptr,
                               size_t memsize,
...
SUNDIALS_EXPORT
int SUNMemoryHelper_Copy_Sycl(SUNMemoryHelper helper,
                              SUNMemory dst,
                              SUNMemory src,
                              size_t memory_size,
                              void *queue);
...
SUNDIALS_EXPORT
int SUNMemoryHelper_CopyAsync_Sycl(SUNMemoryHelper helper,
                                   SUNMemory dst,
                                   SUNMemory src,
                                   size_t memory_size,
                                   void *queue);
