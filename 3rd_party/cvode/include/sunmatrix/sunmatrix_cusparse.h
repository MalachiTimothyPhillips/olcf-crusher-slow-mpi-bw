...
SUNDIALS_EXPORT SUNMatrix
SUNMatrix_cuSparse_NewCSR(int M, int N, int NNZ, cusparseHandle_t cusp, SUNContext sunctx);
SUNDIALS_EXPORT SUNMatrix SUNMatrix_cuSparse_MakeCSR(cusparseMatDescr_t mat_descr,
                                                     int M,
                                                     int N,
                                                     int NNZ,
                                                     int *rowptrs,
...
SUNDIALS_EXPORT SUNMatrix SUNMatrix_cuSparse_NewBlockCSR(int nblocks,
                                                         int blockrows,
                                                         int blockcols,
                                                         int blocknnz,
                                                         cusparseHandle_t cusp,
...
SUNDIALS_EXPORT int
SUNMatrix_cuSparse_CopyToDevice(SUNMatrix device, realtype *h_data, int *h_idxptrs, int *h_idxvals);
SUNDIALS_EXPORT int
SUNMatrix_cuSparse_CopyFromDevice(SUNMatrix device, realtype *h_data, int *h_idxptrs, int *h_idxvals);
