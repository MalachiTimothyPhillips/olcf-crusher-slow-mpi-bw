...
typedef int (*CVLsJacFn)(realtype t,
                         N_Vector y,
                         N_Vector fy,
                         SUNMatrix Jac,
                         void *user_data,
...
typedef int (*CVLsPrecSetupFn)(realtype t,
                               N_Vector y,
                               N_Vector fy,
                               booleantype jok,
                               booleantype *jcurPtr,
...
typedef int (*CVLsPrecSolveFn)(realtype t,
                               N_Vector y,
                               N_Vector fy,
                               N_Vector r,
                               N_Vector z,
...
typedef int (*CVLsJacTimesVecFn)(N_Vector v,
                                 N_Vector Jv,
                                 realtype t,
                                 N_Vector y,
                                 N_Vector fy,
...
typedef int (*CVLsLinSysFn)(realtype t,
                            N_Vector y,
                            N_Vector fy,
                            SUNMatrix A,
                            booleantype jok,
...
SUNDIALS_EXPORT int CVodeSetLinearSolver(void *cvode_mem, SUNLinearSolver LS, SUNMatrix A);
...
SUNDIALS_EXPORT int CVodeSetLinearSolutionScaling(void *cvode_mem, booleantype onoff);
SUNDIALS_EXPORT int CVodeSetDeltaGammaMaxBadJac(void *cvode_mem, realtype dgmax_jbad);
...
SUNDIALS_EXPORT int CVodeSetPreconditioner(void *cvode_mem, CVLsPrecSetupFn pset, CVLsPrecSolveFn psolve);
SUNDIALS_EXPORT int CVodeSetJacTimes(void *cvode_mem, CVLsJacTimesSetupFn jtsetup, CVLsJacTimesVecFn jtimes);
...
SUNDIALS_EXPORT int CVodeGetLinWorkSpace(void *cvode_mem, long int *lenrwLS, long int *leniwLS);
