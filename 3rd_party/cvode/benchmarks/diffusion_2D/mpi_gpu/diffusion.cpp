...
int laplacian(realtype t, N_Vector u, N_Vector f, void *user_data)
{
  ...
  if (check_flag(&flag, "UserData::start_exchange", 1))
    return -1;
  ...
  if (check_flag((void *)farray, "N_VGetDeviceArrayPointer", 0))
    return -1;
  ...
  diffusion_interior_kernel<<<igrid, iblock>>>(t,
                                               uarray,
                                               farray,
                                               is,
                                               js,
  ...
  if (check_flag(&flag, "UserData::end_exchagne", 1))
    return -1;
  ...
  diffusion_boundary_kernel<<<bgrid, bblock>>>(t,
                                               uarray,
                                               farray,
                                               is,
                                               js,
