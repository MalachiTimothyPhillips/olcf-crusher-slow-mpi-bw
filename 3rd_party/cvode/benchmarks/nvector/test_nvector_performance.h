...
int Test_N_VLinearSumVectorArray(N_Vector X, sunindextype local_length, int nvecs, int ntests);
...
int Test_N_VScaleAddMultiVectorArray(N_Vector X, sunindextype local_length, int nvecs, int nsums, int ntests);
int Test_N_VLinearCombinationVectorArray(N_Vector X,
