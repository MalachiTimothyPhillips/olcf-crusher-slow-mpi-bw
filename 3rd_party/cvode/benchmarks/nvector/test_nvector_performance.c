...
static void time_stats(N_Vector X,
                       double *times,
                       int start,
                       int ntimes,
                       double *avg,
...
#define PRINT_TIME1(test, time, sdev, min, max)                                                              \
  if (print_time)                                                                                            \
  printf(FMT1, test, time, sdev, min, max)
...
int Test_N_VLinearCombination(N_Vector X, sunindextype local_length, int nvecs, int ntests)
{
  ...
  PRINT_TIME2("N_VLinearCombination-1",
              favgtime,
              fsdevtime,
              fmintime,
              fmaxtime,
  ...
  time_stats(X, ftimes, nextra, ntests, &favgtime, &fsdevtime, &fmintime, &fmaxtime);
  time_stats(X, utimes, nextra, ntests, &uavgtime, &usdevtime, &umintime, &umaxtime);
  PRINT_TIME2("N_VLinearCombination-2",
              favgtime,
              fsdevtime,
              fmintime,
              fmaxtime,
  ...
  time_stats(X, ftimes, nextra, ntests, &favgtime, &fsdevtime, &fmintime, &fmaxtime);
  time_stats(X, utimes, nextra, ntests, &uavgtime, &usdevtime, &umintime, &umaxtime);
  PRINT_TIME2("N_VLinearCombination-3",
              favgtime,
              fsdevtime,
              fmintime,
              fmaxtime,
...
int Test_N_VScaleAddMulti(N_Vector X, sunindextype local_length, int nvecs, int ntests)
{
  ...
  time_stats(X, ftimes, nextra, ntests, &favgtime, &fsdevtime, &fmintime, &fmaxtime);
  time_stats(X, utimes, nextra, ntests, &uavgtime, &usdevtime, &umintime, &umaxtime);
  PRINT_TIME2("N_VScaleAddMulti-1",
              favgtime,
              fsdevtime,
              fmintime,
              fmaxtime,
  ...
  time_stats(X, ftimes, nextra, ntests, &favgtime, &fsdevtime, &fmintime, &fmaxtime);
  time_stats(X, utimes, nextra, ntests, &uavgtime, &usdevtime, &umintime, &umaxtime);
  PRINT_TIME2("N_VScaleAddMulti-2",
              favgtime,
              fsdevtime,
              fmintime,
              fmaxtime,
 ...
 * --------------------------------------------------------------------*/
int Test_N_VLinearSumVectorArray(N_Vector V, sunindextype local_length, int nvecs, int ntests)
{
  double start_time, stop_time;
  double favgtime, fsdevtime, fmintime, fmaxtime;
  double uavgtime, usdevtime, umintime, umaxtime;
  ...
  PRINT_TIME2("N_VLinearSumVectorArray",
              favgtime,
              fsdevtime,
              fmintime,
              fmaxtime,
 ...
 * --------------------------------------------------------------------*/
int Test_N_VScaleVectorArray(N_Vector X, sunindextype local_length, int nvecs, int ntests)
{
  double start_time, stop_time;
  double favgtime, fsdevtime, fmintime, fmaxtime;
  double uavgtime, usdevtime, umintime, umaxtime;
  ...
  time_stats(X, ftimes, nextra, ntests, &favgtime, &fsdevtime, &fmintime, &fmaxtime);
  time_stats(X, utimes, nextra, ntests, &uavgtime, &usdevtime, &umintime, &umaxtime);
  PRINT_TIME2("N_VScaleVectorArray-1",
              favgtime,
              fsdevtime,
              fmintime,
              fmaxtime,
  ...
  time_stats(X, ftimes, nextra, ntests, &favgtime, &fsdevtime, &fmintime, &fmaxtime);
  time_stats(X, utimes, nextra, ntests, &uavgtime, &usdevtime, &umintime, &umaxtime);
  PRINT_TIME2("N_VScaleVectorArray-2",
              favgtime,
              fsdevtime,
              fmintime,
              fmaxtime,
 ...
 * --------------------------------------------------------------------*/
int Test_N_VConstVectorArray(N_Vector X, sunindextype local_length, int nvecs, int ntests)
{
  double start_time, stop_time;
  double favgtime, fsdevtime, fmintime, fmaxtime;
  double uavgtime, usdevtime, umintime, umaxtime;
  ...
  time_stats(X, ftimes, nextra, ntests, &favgtime, &fsdevtime, &fmintime, &fmaxtime);
  time_stats(X, utimes, nextra, ntests, &uavgtime, &usdevtime, &umintime, &umaxtime);
  PRINT_TIME2("N_VConstVectorArray",
              favgtime,
              fsdevtime,
              fmintime,
              fmaxtime,
 ...
 * --------------------------------------------------------------------*/
int Test_N_VWrmsNormVectorArray(N_Vector X, sunindextype local_length, int nvecs, int ntests)
{
  double start_time, stop_time;
  double favgtime, fsdevtime, fmintime, fmaxtime;
  double uavgtime, usdevtime, umintime, umaxtime;
  ...
  time_stats(X, ftimes, nextra, ntests, &favgtime, &fsdevtime, &fmintime, &fmaxtime);
  time_stats(X, utimes, nextra, ntests, &uavgtime, &usdevtime, &umintime, &umaxtime);
  PRINT_TIME2("N_VWrmsNormVectorArray",
              favgtime,
              fsdevtime,
              fmintime,
              fmaxtime,
 ...
 * N_VWrmsNormVectorArray Test
 * --------------------------------------------------------------------*/
int Test_N_VWrmsNormMaskVectorArray(N_Vector X, sunindextype local_length, int nvecs, int ntests)
{
  double start_time, stop_time;
  double favgtime, fsdevtime, fmintime, fmaxtime;
  double uavgtime, usdevtime, umintime, umaxtime;
  ...
  time_stats(X, ftimes, nextra, ntests, &favgtime, &fsdevtime, &fmintime, &fmaxtime);
  time_stats(X, utimes, nextra, ntests, &uavgtime, &usdevtime, &umintime, &umaxtime);
  PRINT_TIME2("N_VWrmsNormMaskVectorArray",
              favgtime,
              fsdevtime,
              fmintime,
              fmaxtime,
 ...
 * --------------------------------------------------------------------*/
int Test_N_VScaleAddMultiVectorArray(N_Vector V, sunindextype local_length, int nvecs, int nsums, int ntests)
{
  double start_time, stop_time;
  double favgtime, fsdevtime, fmintime, fmaxtime;
  double uavgtime, usdevtime, umintime, umaxtime;
  ...
  time_stats(V, ftimes, nextra, ntests, &favgtime, &fsdevtime, &fmintime, &fmaxtime);
  time_stats(V, utimes, nextra, ntests, &uavgtime, &usdevtime, &umintime, &umaxtime);
  PRINT_TIME2("N_VScaleAddMultiVectorArray-1",
              favgtime,
              fsdevtime,
              fmintime,
              fmaxtime,
  ...
  time_stats(V, ftimes, nextra, ntests, &favgtime, &fsdevtime, &fmintime, &fmaxtime);
  time_stats(V, utimes, nextra, ntests, &uavgtime, &usdevtime, &umintime, &umaxtime);
  PRINT_TIME2("N_VScaleAddMultiVectorArray-2",
              favgtime,
              fsdevtime,
              fmintime,
              fmaxtime,
 ...
 * --------------------------------------------------------------------*/
int Test_N_VLinearCombinationVectorArray(N_Vector V,
